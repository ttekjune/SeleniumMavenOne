...
public class MavenUps {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement text = driver1.findElement(By.xpath("/html/body/div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[3]/td/p/font/b"));
		 ...
		 * driver1.get("https://www.google.com/"); driver1.quit();
		 */
